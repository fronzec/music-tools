...
Ear-training quiz tool. Plays two notes ascending, asks the user to identify the interval from a multiple-choice panel, gives immediate feedback, and tracks score. v1 scope: audio only (no fretboard visualization).
