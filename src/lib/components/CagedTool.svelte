...
<div class="mx-auto max-w-5xl p-4 sm:p-6 lg:p-8">
  <!-- Back button -->
  <button
    class="mb-6 text-sm text-blue-600 hover:text-blue-800 hover:underline"
  ...
  <div class="mb-8 space-y-6">
    ...
    <div>
      <div class="mb-2 text-sm font-medium text-gray-600">Chord</div>
    ...
    <div class="flex items-center gap-4">
      <div class="text-sm font-medium text-gray-600">Quality</div>
    ...
    <!-- Label mode toggle -->
    <div class="flex items-center gap-4">
      <div class="text-sm font-medium text-gray-600">Labels</div>
      <div class="inline-flex rounded-lg border border-gray-300 bg-gray-50 p-0.5">
        <button
          class="rounded-md px-3 py-1 text-sm font-medium transition-colors"
